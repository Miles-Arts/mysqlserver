...
tabla_de_clientes GROUP BY ESTADO, BARRIO; 

SELECT CIUDAD,  MAX(LIMITE_DE_CREDITO) AS LIMITE FROM 
tabla_de_clientes GROUP BY cIUDAD ; 

SELECT ESTADO, BARRIO, MAX(LIMITE_DE_CREDITO) AS LIMITE FROM 
tabla_de_clientes GROUP BY ESTADO, BARRIO; 
